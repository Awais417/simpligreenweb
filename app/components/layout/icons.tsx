...
export function OverviewIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeWidth={1.75}
        d="M3 13h4v8H3v-8zm7-8h4v16h-4V5zm7 5h4v11h-4V10z"
      />
    </svg>
  );
}

export function JobsIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth={1.75}
        d="M3 7h18M3 7v12a1 1 0 001 1h16a1 1 0 001-1V7M3 7l2-4h14l2 4M9 12h6"
      />
    </svg>
  );
}
  ...
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.75}
        d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m5-3.13a4 4 0 100-8 4 4 0 000 8zm7 3.13A4 4 0 0016 7"
      />
    </svg>
  );
}
  ...
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.75}
        d="M7 7h.01M3 11V6a2 2 0 012-2h5l11 11-7 7L3 11z"
      />
    </svg>
  );
}
